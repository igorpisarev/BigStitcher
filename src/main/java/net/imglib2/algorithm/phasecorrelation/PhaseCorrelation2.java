...
public class PhaseCorrelation2 {
	 ...
	 * @param peakFilter for accepting or rejecting peaks based on their location
	...
	public static <T extends RealType<T>, S extends RealType<S>, R extends RealType<R>> PhaseCorrelationPeak2 getShift(
			...
			final long minOverlap, final boolean subpixelAccuracy, final boolean interpolateSubpixel,
			final ExecutorService service, final PeakFilter peakFilter)
	{
		System.out.println( "PCM" );
		final List<PhaseCorrelationPeak2> peaks = PhaseCorrelation2Util.getPCMMaxima( pcm, service, nHighestPeaks, subpixelAccuracy, peakFilter, img1, img2 );
		...
		PhaseCorrelation2Util.calculateCrossCorrParallel(peaks, img1, img2, minOverlap, service, interpolateSubpixel, peakFilter);
	...
	{
		return getShift(pcm, img1, img2, nHighestPeaks, minOverlap, subpixelAccuracy, interpolateSubpixel, service, null);
	}
